 ...
 * <code>oracle.adfdemo.view.feature.rich.graph.dataSource.metadata.Member</code> objects
...
public class Layer {
   ...
   *                  <code>oracle.adfdemo.view.feature.rich.graph.dataSource.metadata.Member</code>
   *                  objects
	 */
	...
	/**
	 * Retrieves a <code>oracle.adfdemo.view.feature.rich.graph.dataSource.metadata.Member</code>
   * by its value.
	 *	
	 * @param value The value of the <code>oracle.adfdemo.view.feature.rich.graph.dataSource.metadata.Member</code> that is being searched for
	 *
	 * @return A <code>oracle.adfdemo.view.feature.rich.graph.dataSource.metadata.Member</code>,
   *         if a match is found.
	 */
