...
/**
 * Custom component for testing calls to ExtendedRenderKitService.addScript().
 */
public class DemoTestPanelAddScript extends UIXPanel
{
  ...
  static public final String COMPONENT_TYPE =
    "oracle.adf.DemoTestPanelAddScript";

  /**
   * Construct an instance of the DemoTestPanelAddScript.
   */
  public DemoTestPanelAddScript()
  {
    super("oracle.adf.rich.test.AddScript");
  }
   ...
   * Construct an instance of the DemoTestPanelAddScript.
   */
  protected DemoTestPanelAddScript(
    String rendererType
    )
  {
    super(rendererType);
  ...
  static
  {
    TYPE.lockAndRegister("oracle.adf.Panel","oracle.adf.rich.test.AddScript");
  }
}
