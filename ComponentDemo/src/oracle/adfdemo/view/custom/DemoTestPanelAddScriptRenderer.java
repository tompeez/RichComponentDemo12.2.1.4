...
public class DemoTestPanelAddScriptRenderer extends RichRenderer
{
  public DemoTestPanelAddScriptRenderer()
  {
    super(DemoTestPanelAddScript.TYPE);
  }

  protected String getClientConstructor()
  {
    return "DemoTestPanelAddScript";
  }
