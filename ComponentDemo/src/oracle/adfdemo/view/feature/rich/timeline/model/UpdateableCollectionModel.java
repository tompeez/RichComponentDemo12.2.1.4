/* $Header: dsstools/modules/dvt-faces-demo/src/oracle/adfdemo/view/feature/rich/timeline/model/UpdateableCollectionModel.java /bibeans_root/3 2011/07/13 15:39:02 ccchow Exp $ */
...
/**
 *  @version $Header: UpdateableCollectionModel.java 08-jul-2011.15:39:00 ccchow   Exp $
 *  @author  ccchow  
  ...
  implements ActiveDataModel, UpdateableModel
{
  ...
  public void refresh()
  {
    _fireModelChangeEvent(ActiveDataEntry.ChangeType.REFRESH, null, null);
  }
                                     ...
                                     Object[] anchorKey)
  {
    if (_adListener != null)
    {
      if (changeType == ActiveDataEntry.ChangeType.REFRESH)
      {
          List<ActiveDataEntry> changeList = new ArrayList<ActiveDataEntry>(1);
          changeList.add(new ActiveDataEntryImpl(changeType, null, null));
