...
/**
 * ActiveTreeTableData implementation for the "active data" visual design demo.
 */
public class ActiveTreeTableData extends TreeModel implements ActiveDataModel
{
  /**
   * Constructor.
   */
  public ActiveTreeTableData()
  {
    _baseString = "Tree Table Node";
  ...
  private class ValueUpdater extends TimerTask
  {
    ...
    public void run()
    {
      ActiveTreeTableData.this._updateActiveData();
    }
  }
